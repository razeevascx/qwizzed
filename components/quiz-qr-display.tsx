...
export function QuizQrDisplay({
  ...
  return (
    <div className="p-8 flex flex-col text-center space-y-8 h-full min-h-150">
      ...
      <div
        ref={qrRef}
        className="relative flex flex-col items-center justify-center transition-all duration-300 w-full p-8 rounded-[40px] bg-transparent shadow-2xl ring-4 ring-primary/5 cursor-zoom-in group/qr [&:fullscreen]:rounded-none [&:fullscreen]:p-0 [&:fullscreen]:bg-[#0F1116] [&:fullscreen]:ring-0 [&:fullscreen]:cursor-default"
      ...
      >
        ...
        <div
          className={`bg-white p-8 rounded-[3rem] shadow-2xl transition-all duration-500 ${isFullscreen ? "scale-110" : ""}`}
        >
          <QRCodeCanvas
            value={url}
